...
async function build(dir, conf = null, reactProductionProfiling = false, debugOutput = false, runLint = true) {
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            const { pages: pagesDir , root: rootDir  } = (0, _findPagesDir).findPagesDir(dir, config.experimental.rootDir);
            ...
            const hasPages404 = (ref7 = mappedPages['/404']) === null || ref7 === void 0 ? void 0 : ref7.startsWith(_constants.PAGES_DIR_ALIAS);
            ...
            if (result.errors.length > 0) {
                ...
                console.error();
                var _errors;
                const edgeRuntimeErrors = (_errors = (ref4 = result.stats[2]) === null || ref4 === void 0 ? void 0 : ref4.compilation.errors) !== null && _errors !== void 0 ? _errors : [];
            ...
            const { customAppGetInitialProps , namedExports , isNextImageImported: isNextImageImported1 , hasSsrAmpPages: hasSsrAmpPages1 , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
                ...
                const errorPageStaticResult = nonStaticErrorPageSpan.traceAsyncFn(async ()=>{
                    var ref, ref8;
                    return hasCustomErrorPage && staticWorkers.isPageStatic('/_error', distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref8 = config.i18n) === null || ref8 === void 0 ? void 0 : ref8.defaultLocale);
                });
                        ...
                        pageRuntime !== 'edge') {
                            try {
                                ...
                                let workerResult = await isPageStaticSpan.traceAsyncFn(()=>{
                                    var ref, ref9;
                                    return staticWorkers.isPageStatic(page, distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref9 = config.i18n) === null || ref9 === void 0 ? void 0 : ref9.defaultLocale, isPageStaticSpan.id);
                                });
            ...
            telemetry.record((0, _events).eventBuildOptimize(pagePaths, {
                ...
                hasReportWebVitals: (ref5 = namedExports === null || namedExports === void 0 ? void 0 : namedExports.includes('reportWebVitals')) !== null && ref5 !== void 0 ? ref5 : false,
            ...
            if (ssgPages.size > 0) {
                ...
                await generateClientSsgManifest(prerenderManifest, {
                    distDir,
                    buildId,
                    locales: ((ref6 = config.i18n) === null || ref6 === void 0 ? void 0 : ref6.locales) || []
                });
            } else {
                const prerenderManifest = {
                    version: 3,
