...
class DevServer extends _nextServer.default {
    ...
    constructor(options){
        ...
        const { pages: pagesDir , root: rootDir  } = (0, _findPagesDir).findPagesDir(this.dir, this.nextConfig.experimental.rootDir);
        ...
        return new Promise((resolve, reject)=>{
            ...
            wp.on('aggregated', async ()=>{
                ...
                for (const [fileName, { accuracy , safeTime  }] of knownFiles){
                    ...
                    const pageName = (0, _absolutePathToPage).absolutePathToPage(this.pagesDir, fileName, this.nextConfig.pageExtensions);
